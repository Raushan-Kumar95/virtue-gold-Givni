      ...
      <div className=' flex md:flex-row flex-col bg-blue-300 shadow-2xl rounded-md'>
        ...
        <div className='md:p-10 p-5 w-[400px]'>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button className='bg-green-500 hover:bg-green-600 text-white text-xl font-semibold py-2 px-3 my-4 w-full hover:duration-300 hover:shadow-lg'><Link to='/otp'>SIGNUP</Link></button>
