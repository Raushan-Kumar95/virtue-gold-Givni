    ...
    <div className=" flex flex-col md:ml-[20vh] h-[80vh] md:min-h-[80vh]  items-center">
        ...
        <div className="">
            ...
            <div className=" flex gap-10">
                ...
                <div className={active==3?"cursor-pointer border-b-2 border-b-red-600":"cursor-pointer"} onClick={()=>{setProduct(['Silver','Sell']); setActive(3)}}>Sell Gold</div>
            </div>
            <hr className=' ' />
        </div>
        ...
        {/* <BuyCoin /> */}
        <BuySilver p_name={product[0]} buy_sell={product[1]} />
    </div>
</>
    )
}
